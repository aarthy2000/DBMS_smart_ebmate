...
<div class="form-group <?php echo (!empty($id_err)) ? 'has-error' : ''; ?>">
	...
	<input type="text" name="phone1" class="form-control" value="<?php echo $id; ?>">
	<span class="help-block"><?php echo $id_err; ?></span>
	</div>
<!--2-->
...
<div class="form-group <?php echo (!empty($id_err)) ? 'has-error' : ''; ?>">
	<label>Phone Number</label>
	<input type="text" name="phone2" class="form-control" value="<?php echo $id; ?>">
	<span class="help-block"><?php echo $id_err; ?></span>
	</div>
<!--3-->
...
<div class="form-group <?php echo (!empty($id_err)) ? 'has-error' : ''; ?>">
	<label>Phone Number</label>
	<input type="text" name="phone3" class="form-control" value="<?php echo $id; ?>">
	<span class="help-block"><?php echo $id_err; ?></span>
	</div>
