...
<div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
      ...
      <a href="mail.php" class="btn btn-danger">SendMail</a>
      <a href="staff_index.html" class="btn btn-danger">Back</a>
