...
$empty_err="";
$phnum_err=$street_err=$state_err=$name_err=$dob_err=$city_err=$email_err="";
...
if(empty(trim($_POST["name"]))){
 ...
 if(empty(trim($_POST["phnum"])) or (strlen($_POST["phnum"])<10)){
        $phnum_err = "Please enter a valid phone number.";
    }
if(empty(trim($_POST["email"])) or (!strpos($_POST["email"],'@'))){
...
if(empty(trim($_POST["pincode"])) or (strlen($_POST["pincode"])<6) ){
        $pincode_err = "Please enter the valid  pincode.";
    }
//	if(empty(trim($_POST["dob"]))){
 //       $dob_err = "Please enter the Date of Birth.";
  //  }
    ...
    if(empty($username_err) && empty($password_err) &&empty($pincode_err) && empty($confirm_password_err) && empty($phnum_err) && empty($email_err)){
